        ...
        <div className="border-t border-border">
          ...
          {toolResult && (
            <div className="border-t border-border px-3 py-2.5">
              ...
              <div
                className={`rounded-md p-2.5 font-mono text-[11px] whitespace-pre-wrap overflow-x-auto ${toolResult.is_error ? 'bg-red-950/30 text-red-300/80 border border-red-900/30' : 'bg-secondary text-muted-foreground border border-border'}`}
              >
